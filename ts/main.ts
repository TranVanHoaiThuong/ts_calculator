...
const addToScreen = (value: string, isOperator: boolean = false): void => {
...
const isDecimalNumber = (num: string | number): boolean => {
...
const getDecimalNumber = (num: string): string => {
    let number = Number.parseFloat(num);
    return number.toFixed(5);
}

const execCalculate = (calculation: string): void => {
    clearScreen();
